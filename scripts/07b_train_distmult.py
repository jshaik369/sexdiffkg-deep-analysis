#!/usr/bin/env python3
"""
Train DistMult graph embeddings on SexDiffKG.

DistMult uses real-valued bilinear scoring (no complex numbers),
making it compatible with ARM64 CUDA on GB10.
...
def main():
    ...
    logger.info(f"  Hits@100: {metrics.get('hits_at_100', 0):.6f}")
